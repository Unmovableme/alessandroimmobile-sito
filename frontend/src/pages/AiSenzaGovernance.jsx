...
export default function AiSenzaGovernance() {
  return (
    <>
      ...
      />
      <PageContainer testId="ai-page">
        <PageTitle testId="ai-title">
          L'intelligenza artificiale è già in azienda. Nessuno la governa.
        </PageTitle>

        <Lead>
          In un team, qualcuno ha già usato uno strumento di intelligenza artificiale per scrivere
          più veloce, riassumere un documento, preparare una risposta. Nessuno gliel'ha vietato,
          nessuno l'ha organizzato: lo ha fatto e basta, con un account personale, senza che
          l'azienda lo sapesse.
        </Lead>

        <SectionTitle>L'adozione corre prima della governance</SectionTitle>
        <Body>
          Secondo una survey WalkMe/SAP del 2025, il 78% dei dipendenti usa strumenti di
          intelligenza artificiale al di fuori di quelli forniti dall'azienda. Non è un'eccezione, è
          la norma: l'adozione anticipa quasi sempre le decisioni organizzative su come usarla.
        </Body>

        <SectionTitle>Usarla non significa averla integrata</SectionTitle>
        <Body>
          ...
          39% dichiara un impatto misurabile sui risultati. Più output non significa più valore:
          senza un metodo, l'aumento di produttività può anche ridurre la qualità del lavoro.
        </Body>

        <SectionTitle>Lo strumento non è il processo</SectionTitle>
        <Body>
          Scegliere un software è la parte visibile e veloce. Il lavoro che conta è capire quale
          processo quello strumento dovrebbe migliorare: dove si perde tempo, dove nascono gli
          errori, quali passaggi rallentano il lavoro. Partire dallo strumento invece che dal
          processo produce un supporto utile al singolo, difficile da collegare a un risultato per
          l'azienda.
        </Body>

        <SectionTitle>Il dato è il prerequisito, non un dettaglio</SectionTitle>
        <Body>
        ...
        <SectionTitle>Cosa costa non governarla</SectionTitle>
        <Body>
          Il rischio non è solo la sicurezza dei dati. Secondo IBM, le organizzazioni con un uso
          diffuso e non governato dell'intelligenza artificiale hanno subito in media 670.000
          dollari in più di costi legati a violazioni, rispetto a quelle con un uso limitato o
          assente. La causa più comune non è l'assenza di strumenti di sicurezza, ma l'assenza di
          controlli sull'accesso.
        </Body>

        <SectionTitle>Dove sta il lavoro</SectionTitle>
        <Body>
          Mappare come funziona oggi il processo, prima di introdurre qualsiasi strumento.
          Ridisegnare il processo, non aggiungere l'intelligenza artificiale sopra quello che c'è
          già. Strutturare l'ambiente informativo su cui lavora, un punto unico di accesso a dati e
          informazioni. Definire poche regole chiare su cosa si può fare, con quali dati, con quale
