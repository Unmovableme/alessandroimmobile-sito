  ...
  >
    <div className="mx-auto max-w-3xl px-6 py-14">
      <p className="text-sm leading-relaxed text-gray-500 max-w-2xl">
        ...
        1996 lavoro su bilanci, finanza e assetti societari. Dal 2019 affianco startup e
        founder come advisor, business angel e investor, dalla costituzione alla raccolta
        di capitali fino alla governance.
      </p>
