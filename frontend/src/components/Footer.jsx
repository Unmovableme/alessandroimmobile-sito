  ...
  >
    <div className="mx-auto max-w-3xl px-6 py-14">
      <p className="text-sm leading-relaxed text-gray-500 max-w-2xl">
        ...
        lavoro su bilanci, finanza e assetti societari. Dal 2019 affianco i founder come
        advisor, business angel e investor, su nascita, raccolta di capitali e governance
        delle startup.
      </p>
